...
vi.mock("../../../native-plugins/discord/src/accounts.js", () => ({
  resolveDiscordAccount: resolveDiscordAccountMock,
}));

vi.mock("../../../native-plugins/discord/src/probe.js", () => ({
  fetchDiscordApplicationId: async () => "app-1",
}));

vi.mock("../../../native-plugins/discord/src/token.js", () => ({
  normalizeDiscordToken: (value?: string) => value,
}));

vi.mock("../../../native-plugins/discord/src/voice/command.js", () => ({
...
vi.mock("../../../native-plugins/discord/src/monitor/auto-presence.js", () => ({
...
vi.mock("../../../native-plugins/discord/src/monitor/exec-approvals.js", () => ({
...
vi.mock("../../../native-plugins/discord/src/monitor/gateway-plugin.js", () => ({
  createDiscordGatewayPlugin: () => ({ id: "gateway-plugin" }),
}));

vi.mock("../../../native-plugins/discord/src/monitor/listeners.js", () => ({
...
vi.mock("../../../native-plugins/discord/src/monitor/message-handler.js", () => ({
  createDiscordMessageHandler: createDiscordMessageHandlerMock,
}));

vi.mock("../../../native-plugins/discord/src/monitor/native-command.js", () => ({
...
vi.mock("../../../native-plugins/discord/src/monitor/presence.js", () => ({
  resolveDiscordPresenceUpdate: () => undefined,
}));

vi.mock("../../../native-plugins/discord/src/monitor/provider.allowlist.js", () => ({
  resolveDiscordAllowlistConfig: resolveDiscordAllowlistConfigMock,
}));

vi.mock("../../../native-plugins/discord/src/monitor/provider.lifecycle.js", () => ({
  runDiscordGatewayLifecycle: monitorLifecycleMock,
}));

vi.mock("../../../native-plugins/discord/src/monitor/rest-fetch.js", () => ({
  resolveDiscordRestFetch: () => async () => {
    throw new Error("offline");
  },
}));

vi.mock("../../../native-plugins/discord/src/monitor/thread-bindings.js", () => ({
